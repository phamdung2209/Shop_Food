...
<form role="form" action="" method="POST" enctype="multipart/form-data">
    ...
    <div class="col-sm-12">
        <div class="box box-warning">
            ...
            <div class="box-body">
                            ...
                            <select name="keywords[]" class="form-control js-select2-keyword" multiple="">
                                ...
                                @foreach ($keywords as $keyword)
                                    <option value="{{ $keyword->id }}"
                                        {{ in_array($keyword->id, $keywordOld) ? "selected='selected'" : '' }}>
                ...
                <div class="form-group ">
                    ...
                    <textarea name="pro_description" class="form-control" id="pro_description" cols="5" rows="2"
        ...
        @if (!empty($attributesWeight))
            <div class="box-body">
                <label class="control-label">Khối lượng <b class="col-red">(*)</b></label>
                @foreach ($attributesWeight as $key => $attribute)
                        <div class="form-group col-sm">
                            <select name="id" class="form-control ">
                                <option value="">__Click__</option>
                            @foreach ($attributesWeight[0]['attributes'] as $key => $item)
                                    <div class="col-sm-3 checkbox">
                                            <option type="checkbox" name="attribute[]" {{ in_array($item['id'], $attributeOld ) ? "checked"  : '' }}
        ...
        @endif
                    ...
                    <div class="box-body">
                        @foreach ($attributes as $key => $attribute)
                            @if (!empty($attribute['attributesSize']))
                                <div class="form-group col-sm-12">
                                    @foreach ($attribute['attributesSize'] as $key => $item)
